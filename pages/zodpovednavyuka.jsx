...
export default function Zodpovednavyuka() {
  return (
    <main className="">
      <div className="flex w-full my-20 bg-slate-100 shadow-xl py-20 scroll-mt-32	">
            ...
            <div className="lg:py-6 lg:pr-16">
              ...
              <div className="flex">
                ...
                <div className="pt-1 pb-8">
                  ...
                  <p className="text-gray-700">
                    Rozdělení projektu na menší logické části, odsouhlasení
                    řešení i rozsahu prací a následná shoda nad výslednou cenou.
                  </p>
                </div>
              </div>
              <div className="flex">
              ...
              <div className="pt-12">
                Spolupracuji s dalšími specialisty z jiných oblastí, kteří pro
                Vás mohou zpracovat navazující úkony,{" "}
